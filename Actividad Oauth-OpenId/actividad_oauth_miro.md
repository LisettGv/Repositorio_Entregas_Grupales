Actividad: Autenticación y Autorización (OAuth / OIDC)
Asignatura: Desarrollo Cloud Native I  
Servicio Seleccionado: Miro  
Flujo: OAuth Authorization Code Grant  
...
8. Respuesta: El Resource Server valida el token y devuelve los datos requeridos.
